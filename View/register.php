          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" method="POST" id="formRegisterUser">
                ...
                <div class="text-center mt-4 font-weight-light" style="margin-bottom: -30px;">
                  ¿Ya tienes cuenta? <a href="<?php echo base_url; ?>Login" class="text-primary">Inicia sesión</a>
                </div>
